...
import { Plus, ShoppingCart, Trash2, Copy, Clock, Globe, Settings } from "lucide-react";
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Add a new list to organize your shopping items</DialogDescription>
                </DialogHeader>
            ...
            <Dialog open={isPasteDialogOpen} onOpenChange={setIsPasteDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Paste items from WhatsApp or any other source</DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                ...
                <DialogFooter>
                  ...
                  <Button 
                    ...
                    className="bg-green-600 hover:bg-green-700"
                  >
                    {pasteMutation.isPending ? 'Creating...' : 'Create List'}
                  </Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
